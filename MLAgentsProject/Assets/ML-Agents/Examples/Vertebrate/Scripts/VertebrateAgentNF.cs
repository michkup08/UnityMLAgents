...
public class VertebrateAgentNF : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        // [ZMIENIONE] Dodano maskę warstw, żeby raycast środka ciała również ignorował własne collidery
        RaycastHit hit;
        ...
        // [NOWE] Zbieranie danych o terenie z każdej nogi (dolne segmenty nóg)
